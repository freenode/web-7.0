...
slug: atheme-7-2-and-trumpnode
title: Atheme 7.2 and trumpnode
imported: yes
robots: noindex
---
Hello!
...
Details of how to do so are [here](https://github.com/atheme/ecdsatool) and [our SASL page](https://trumpnode.net/sasl/) will be updated with the relevant documentation soonish.


You should be able to connect to testnet at testnet.trumpnode.net Port 9002 for cleartext, and 9003 for SSL. Bear in mind, the database is a couple weeks old, so changes you've recently made on the production network may not be mirrored on the testnet network. Various amounts of staff should be idling in #trumpnode on testnet at all times, please feel free to poke us with any questions.
