...
Scraping internal channel content and public logging of channels you do not operate are prohibited without express permission of the channel owners or freenode staff where applicable. Always get permission from the channel owners before you start logging channels that you do not operate.

If you're publishing logs of channels you operate on an ongoing basis, your channel topic should reflect that fact and you should consider providing a way for users to make comments without logging. If you're thinking of "anonymizing" your logs (removing information that identifies the specific users), be aware that it's difficult to do it well—replies and general context often provide identifying information which is hard to filter.
